const Testimonial = ({content}) => (
  <div class="px-10 py-24 mx-auto md:px-12 max-w-7xl">
    <div class="w-full mx-auto text-center xl:w-1/2 lg:w-3/4">
      ...
      <p class="text-base leading-relaxed md:text-lg">Highly recommended for anyone needing to get a home energy rating done. Always a quick turnaround and very helpful feedback.</p>
      <span class="inline-block w-10 h-1 mt-8 mb-6 bg-indigo-500 rounded"></span>
      <h2 class="text-sm font-medium tracking-wider text-gray-900 uppercase title-font">{content.name}</h2>
      <p class="text-gray-500">Residential Space</p>
    </div>
  </div>
)
